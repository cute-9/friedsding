<template>
  ...
  <div class="login-container">
    ...
    <img src="../assets/snow/snow1.png" id="imgs1" style="display:none" />
    <img src="../assets/snow/snow4.png" id="imgs2" style="display:none" />
    <img src="../assets/snow/snow3.png" id="imgs3" style="display:none" />
    <img src="../assets/snow/snow2.png" id="imgs4" style="display:none" />
    <canvas id='myCanvas' >
...
.login-container {
  ...
  background: url("../assets/snow/snow.png") no-repeat;
   opacity: 0.5;
