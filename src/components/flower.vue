<template>
  ...
  <div class="login-container">
    ...
    <img src="../assets/snow/小花 (1).png" id="imgs1" style="display:none" />
    <img src="../assets/snow/小花.png" id="imgs2" style="display:none" />
    <img src="../assets/snow/花 (1).png" id="imgs3" style="display:none" />
    <img src="../assets/snow/梅花.png" id="imgs4" style="display:none" />
    <canvas id='myCanvas' >
