<template>
  ...
  <div class="login-container">
    ...
    <img src="../assets/snow/树叶 (1).png" id="imgs1" style="display:none" />
    <img src="../assets/snow/树叶.png" id="imgs2" style="display:none" />
    <img src="../assets/snow/树叶h.png" id="imgs3" style="display:none" />
    <img src="../assets/snow/树叶j.png" id="imgs4" style="display:none" />
    <canvas id='myCanvas' >
